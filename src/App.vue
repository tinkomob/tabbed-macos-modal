...
<template>
    ...
    <!-- <template #sidebar>
        <span style="background-color: red;" @click="modal.goto('test')">test</span> 
    ...
    <TabbedModalItem name="test3" title="Модификации" head-title="MODIF">
    ...
    <TabbedModalItem name="sostav" title="Состав">
